...
public class OrderListServlet extends HttpServlet {
    ...
    if (!"admin".equals(user.getRole())) {
        ...
        try {
            List<Order> orders = orderDAO.getAllOrders();  // lấy tất cả đơn hàng
    ...
    try {
        if (orderIds != null && statuses != null && orderIds.length == statuses.length) {
        ...
        e.printStackTrace();
        response.sendError(500, "Lỗi cập nhật trạng thái đơn hàng.");
    }
